...
(function () {
    ...
    var translate = {
        ...
        "it" : {
            ...
            sure_overwrite : 'Sicuro di voler sovrascrivere tutti i dati?',
            link : "Link",
            ...
            imported : "Importato",
            builds : "Rinfreschi",
            ddt : "Temperatura Impasto Desiderata",
    ...
    function Ingredient(name, value, weight, isSourdoughSeed) {
        this.name = name;
        this.value = value;                         // %
        this.weight = weight;                       // grams
        this.isSourdoughSeed = isSourdoughSeed;
    }
    ...
    app.controller("bcCtrl", function ($scope, $ionicPlatform, $ionicPopup, $ionicModal, $ionicScrollDelegate, $ionicTabsDelegate, $ionicListDelegate) {
            ...
            calculate : function () {
                ...
                for (idx = 0; idx < $scope.preferment.preferments.length; idx++) {
                    ...
                    if (prefIn.type === "sourdough") {
                        prefOut.push(new Ingredient("(" + $scope.t.sourdough_seed + ")", prefIn.seed, prefIn.seed * prefScaleDoughFactor, true));
                    }
        ...
        $scope.showDonate = function () {
            $ionicPopup.alert({
                ...
                template: "<p style='text-align: center;'>If you like the App<br/>support me with a beer!<br/>Thank you</p><p style='width: auto; text-align: center;'><a href='https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=YWVFRGAC55UX4'><img src='icons/donate.gif'/></a></p>",
                okText: $scope.t.close.toUpperCase()
            });
        };
